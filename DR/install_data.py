...
if os.path.exists('mwxKTEtelILoIbMbruuM.zip') == False:
    while True:
        ...
        if buer_three == '2':
            print(r'https://huggingface.co/Fallingmeteorite/xformers0.0.14_and_xformers0.0.16/resolve/main/xformers-0.0.14.dev0-cp310-cp310-win_amd64.whl')
            ...
            download("https://huggingface.co/Fallingmeteorite/xformers0.0.14_and_xformers0.0.16/resolve/main/xformers-0.0.14.dev0-cp310-cp310-win_amd64.whl","xformers-0.0.14.dev0-cp310-cp310-win_amd64.whl")
