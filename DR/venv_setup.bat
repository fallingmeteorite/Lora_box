...
set curpath=%~dp0 
cd /d %curpath%
set exename=xformers-0.0.16-cp310-cp310-win_amd64.whl
set downurl=https://huggingface.co/Fallingmeteorite/xformers0.0.14_and_xformers0.0.16/resolve/main/xformers-0.0.16-cp310-cp310-win_amd64.whl
powershell curl -o "%exename%" "%downurl%"
